...
meTl.from('.me', {
  ...
  ease: 'elastic.out(0.5, 0.2)'
}, 0.75).from('.eyebrow-right , .eyebrow-left', {
  duration: 1,
  yPercent: 300,
  ease: 'elastic.out(0.5, 0.2)'
}, 0.7).to('.eye-right , .eye-left', {
  duration: 0.01,
  opacity: 1
}, 0.85).to('.eye-right-2 , .eye-left-2', {
  duration: 0.01,
  opacity: 0
}, 0.85)
...
blink.to('.eye-right, .eye-left', {
  duration: 0.01,
  opacity: 0
}, 0).to('.eye-right-2, .eye-left-2', {
  duration: 0.01,
  opacity: 1
}, 0).to('.eye-right, .eye-left', {
  duration: 0.01,
  opacity: 1
}, 0.15).to('.eye-right-2 , .eye-left-2', {
  duration: 0.01,
  opacity: 0
}, 0.15)
